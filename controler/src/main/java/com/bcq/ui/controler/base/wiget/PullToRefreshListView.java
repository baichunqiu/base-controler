...
import com.bcq.ui.controler.base.utiles.DateUtil;
...
public class PullToRefreshListView extends BaseListView implements OnScrollListener {
    ...
    public void onRefreshComplete() {
        ...
        hideFooter();
        state = DONE;
        lastUpdatedTextView.setText("最近更新:" + DateUtil.formatDate2String(new Date(), DateUtil.FORMAT_HH_MM_SS));
        changeHeaderViewByState();
    }
